...
if __name__=='__main__':
    ...
    case={'price':6000,'purpose':'game','use_time':'evening','game':'online','screen':'medium'}
    case2={'price': 4500,'purpose':'work','use_time':'evening','software':'art_design','screen':'medium'}
    #case={'function': 'video'}
